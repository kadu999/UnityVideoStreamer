...
namespace VideoStream
{
    internal sealed class UdpTargetDiscovery : IDisposable
    {
        ...
        readonly Dictionary<string, IPEndPoint> _targets =
            new Dictionary<string, IPEndPoint>(System.StringComparer.OrdinalIgnoreCase);
        readonly HashSet<string> _localIps = new HashSet<string>(System.StringComparer.OrdinalIgnoreCase);

        Socket _socket;
        Thread _thread;
        volatile bool _running;

        public event System.Action<IPEndPoint> TargetDiscovered;
